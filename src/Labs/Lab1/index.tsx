        ...
        <div id="wd-lab1">
            ...
            <div id="wd-p-tag">
                ...
                <p id="wd-p-1"> This is a paragraph. We often separate a long set of sentences with vertical spaces to
                    ...
                    Browsers ignore vertical white spaces and render all the text as one single set of sentences. To
                    force the browser to add vertical
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    <input type="email" id="wd-text-fields-email" placeholder="webdev@example.com"/> <br/>
            ...
            <button id="wd-all-good" onClick={() => alert("click the button")} type="button">
                click!
            </button>
